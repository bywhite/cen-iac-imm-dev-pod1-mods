...
output "server_profile_names" {
  description = "Names of the created server profiles"
  value       = intersight_server_profile.server_profiles.name
}

output "server_profile_moids" {
  description = "MOID of the created server profile template"
  value       = intersight_server_profile.server_profiles.moid
}
